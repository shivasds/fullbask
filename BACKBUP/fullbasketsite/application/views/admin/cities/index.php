                            ...
                            if ($cities) {
                                foreach ($cities as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $value->email ?></td>
                                        <td><?= substr($value->address, 0, 50) ?></td>
                                        <td><?= $value->phone ?></td>
                                        <td style="width:10%;">
                                            <a href="<?= site_url('admin/cities/delete/' . $value->id) ?>" onclick="return confirm('Are you sure you want to delete the Property Type');" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                            <a href="<?= site_url('admin/cities/edit/' . $value->id) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
