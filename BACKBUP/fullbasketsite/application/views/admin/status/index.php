        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Property Status</h3>
                </div>
                <!-- /.box-header -->
                            ...
                            if ($statuses) {
                                foreach ($statuses as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $value->name ?></td>
                                        <td style="width:10%;">
                                            <a href="<?= site_url('admin/status/delete/' . $value->id) ?>" onclick="return confirm('Are you sure you want to delete the Property Status');" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                            <a href="<?= site_url('admin/status/edit/' . $value->id) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
