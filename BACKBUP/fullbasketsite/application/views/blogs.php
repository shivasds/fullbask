                    ...
                    <div class="card">
                        ...
                        <div class="card-block" style="min-height: 270px;margin-bottom: 5px;position: relative;">
                            ...
                            <div style="position: absolute;bottom: 10px; right: 5px; position: absolute;width: 100%">
                                <hr />
                                <a class="btn btn-primary pull-right" style="border-radius: 0; " target="_blank"  href='<?=site_url("blog/$blog->slug")?>'>Details Of Blog <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </a>
