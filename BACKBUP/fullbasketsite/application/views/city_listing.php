							...
							<div class="thumbnail">
								<div class="row">
									...
									<div class="prop-content col-sm-8 col-md-4">
										<div class="caption">
											<a target="_blank"  href="<?=site_url(url_title($property->city_name)."/".( url_title($property->area) )."/$property->slug/")?>"><h3 class="group inner list-group-item-heading" style="font-size: 20px;font-weight: 600;">
                                                    <?= $property->title ?></h3></a>
											...
											<div class="prop-details">
												...
												<p><?= $property->prop_type ?><br><span>Type</span></p>
