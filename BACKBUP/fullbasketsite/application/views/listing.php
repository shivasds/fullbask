                        ...
                        <div class="col-sm-12">
                            ...
                            ?>
                                <form method="post" action="">
                                    <div class="form-group">
                                        <input type="text" name="keyword"  placeholder="Enter a Location, Builder or a Project" class="form-control" value="<?= $keyword ? $keyword : $content['keyword'] ?>">
                                        <input type="hidden" id="showPattern" name="showPattern" value="">
                                        <button type="submit" class="btn btn-loc">Search</button>
                                        <a href="#"id="foo"  class="btn pull-right btn-link">Advance Search</a>
                                    </div>
