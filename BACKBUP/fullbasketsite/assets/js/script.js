...
$(function () {
    var slide1_totalItems = $('#slide1 .item').length;
    if(slide1_totalItems>3){
        var nav = true;
        var autoP = true;   
    }
    else {
    ...
    var slide2_totalItems = $('#slide2 .item').length;
    if(slide2_totalItems>3){
        var nav = true;
        var autoP = true;   
    }
    else {
...
$(document).ready(function () {
    ...
    if (typeof lightSlider != 'undefined') {
        ...
        $(".ach_modal_opener").on('click', function (e) {
            ...
            $("#achievement_modal .ach_image").prop('alt', $(this).find('.ach_alt').val());
            $("#achievement_modal .ach_image").prop('title', $(this).find('.ach_desc').val());
        ...
        $(document).ready(function () {
            ...
            _floatbox.css("right", "-261px"); //initial contact form position

            //Contact form Opener button
            _floatbox_opener.click(function () {
                if (_floatbox.hasClass('visiable')) {
                    _floatbox.animate({"right": "-261px"}, {duration: 300}).removeClass('visiable');
                } else {
