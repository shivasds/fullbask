 ...
 *   	),
 * ...
 * - list of valid photo_size values is described here http://developer.foursquare.com/docs/responses/photo.html
...
class Hybrid_Providers_Foursquare extends Hybrid_Provider_Model_OAuth2
{
	...
	*/
	function initialize()
	{
		...
		$this->api->api_base_url  = "http://api.foursquare.com/v2/";
		$this->api->authorize_url = "http://foursquare.com/oauth2/authenticate";
		$this->api->token_url     = "http://foursquare.com/oauth2/access_token";
