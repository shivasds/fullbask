...
class Hybrid_Providers_Live extends Hybrid_Provider_Model_OAuth2
{
	...
	*/
	function initialize() 
	{
		...
		$this->api->api_base_url  = 'http://apis.live.net/v5.0/';
		$this->api->authorize_url = 'http://login.live.com/oauth20_authorize.srf';
		$this->api->token_url     = 'http://login.live.com/oauth20_token.srf';
