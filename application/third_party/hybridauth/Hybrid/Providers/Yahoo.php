...
class Hybrid_Providers_Yahoo extends Hybrid_Provider_Model_OAuth1
{
	function initialize() 
	{
		...
		$this->api->authorize_url     = 'http://api.login.yahoo.com/oauth/v2/request_auth';
		$this->api->request_token_url = 'http://api.login.yahoo.com/oauth/v2/get_request_token';
		$this->api->access_token_url  = 'http://api.login.yahoo.com/oauth/v2/get_token';
	}
