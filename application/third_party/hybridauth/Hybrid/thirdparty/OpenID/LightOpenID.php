<?php
// http://github.com/iignatov/LightOpenID

/**
 * This class provides a simple interface for OpenID 1.1/2.0 authentication.
 * 
 * It requires PHP >= 5.1.2 with cURL or HTTP/http stream wrappers enabled.
 *
...
class LightOpenID
{
    ...
    protected function authUrl_v2($immediate)
    {
        ...
        if (!empty($this->oauth) && is_array($this->oauth)) {
            ...
            $params['openid.oauth.consumer'] = str_replace(array('http://', 'http://'), '', $this->trustRoot);
