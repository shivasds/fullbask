...
<div class="container">
    <div class="row about-content">
        <div class="col-sm-12">
            ...
            //            } else {
            ?>
            <!--                <img src="http://placehold.it/527x388" class="img-responsive" style="width:100%;">-->
            <?php
            //            }
            ?>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="text-center hide">
                        ...
                        if (($images = $this->aboutUs_model->getWhere(array('name' => 'client_images'),
                            ...
                            ?>
                            <!-- <img style="display: inline-block; margin-right: 1%" src="http://placehold.it/120x350" class="img-responsive">-->
                            <?php
                        }
                        ?>
                    </div>
