                            ...
                            if ($achievements) {
                                foreach ($achievements as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img style="height: 90px; width: 90px;" src="<?= base_url('uploads/achievements/' . $value->image) ?>"></td>
                                        <td style="width:10%;">
                                            <a href="<?= site_url('admin/achievements/delete/' . $value->id) ?>" onclick="return confirm('Are you sure you want to delete the Achievement');" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                            <a href="<?= site_url('admin/achievements/edit/' . $value->id) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                }
