                        ...
                        if ($careers) {
                            foreach ($careers as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $value->title ?></td>
                                    <td style="width:20%;">
                                        <a href="<?= site_url('admin/career/delete/' . $value->id) ?>"
                                           onclick="return confirm('Are you sure you want to delete the Career');"
                                           class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                        <a href="<?= site_url('admin/career/edit/' . $value->id) ?>"
