        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Property Flat Types</h3>
                </div>
                <!-- /.box-header -->
                ...
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <?php
                        if ($flat_types) {
                            foreach ($flat_types as $key => $value) {
                                ?>
                                <tr>
                                    <td><?= (($page - 1) * $perpage + ($key + 1)) ?></td>
                                    <td><?= $value->name ?></td>
                                    <td style="width:20%;">
                                        <a href="<?= site_url('admin/flat_type/delete/' . $value->id) ?>"
                                           onclick="return confirm('Are you sure you want to delete the Property Flat Type');"
                                           class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                        <a href="<?= site_url('admin/flat_type/edit/' . $value->id) ?>"
