    ...
    <div class="form-group">
        ...
        <div class=" <?= form_error('floors') ? 'has-error' : '' ?>">
            <select name="floors" id="floors" class="form-control">
                ...
                for ($i = 1; $i < 6; $i++) {
                    ?>
                    <option <?= $property->floors == $i ? "selected" : "" ?>
                    value="<?= $i ?>"><?= $i ?></option>
                    <?php
                }
                ?>
                <option <?= $property->floors == "Multiple" ? "selected" : "" ?>
                value="Multiple">Multiple
            </option>
        </select>
    ...
    <div class="form-group">
        ...
        <div class=" <?= form_error('towers') ? 'has-error' : '' ?>">
            <select name="towers" id="towers" class="form-control">
                ...
                for ($i = 1; $i < 6; $i++) {
                    ?>
                    <option <?= $property->towers == $i ? "selected" : "" ?>
                    value="<?= $i ?>"><?= $i ?></option>
                    <?php
                }
                ?>
                <option <?= $property->towers == "Multiple" ? "selected" : "" ?>
                value="Multiple">Multiple
            </option>
        </select>
    ...
    <div class="form-group">
        ...
        <div class=" <?= form_error('units') ? 'has-error' : '' ?>">
            <select name="units" id="units" class="form-control">
                ...
                for ($i = 1; $i < 6; $i++) {
                    ?>
                    <option <?= $property->units == $i ? "selected" : "" ?>
                    value="<?= $i ?>"><?= $i ?></option>
                    <?php
                }
                ?>
                <option <?= $property->units == "Multiple" ? "selected" : "" ?>
                value="Multiple">Multiple
            </option>
        </select>
