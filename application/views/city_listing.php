                                                        ...
                                                        if (($flatTypes = $this->properties_model->getPropertyFlatType(null,$property->id)) != null){
                                                            foreach ($flatTypes as $flatType) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="https://api.whatsapp.com/send?phone=918342063684&text=HI TEAM FBP, I would be interested to know about%20<?= $property->title ? $property->title : '' ?>%20Project%20 <?= $flatType->flat_type ?>" target="_blank"><img style="float: none;"src="<?= base_url('assets/banner_patch/whatsapp.png') ?>"> </a></td>
