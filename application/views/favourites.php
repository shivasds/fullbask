				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="col-sm-5">
							...
							<form>
								<div class="form-group">
									<input type="text" name="location" placeholder="Enter a Location, Builder or a Projet" class="form-control">
					            ...
					            <div class="thumbnail">
							        <div class="row">
						                ...
						                <div class="prop-content col-sm-8 col-md-4">
						                	<div class="caption">
							                    <a target="_blank"  href="<?=site_url(url_title($property->city_name)."/".( url_title($property->area) )."/$property->slug/")?>"><h3 class="group inner list-group-item-heading">
                                                        <?= $property->title ?></h3></a>
