        ...
        <div class="row">
         ...
         <section id="section-id-1507611922"  class="sppb-section   rooms-suits resort-title-heading wow">
                                <div class="sppb-row-container">
                                    ...
                                    //echo $side_image; die;
                                            ?>
                                        <h4><b><?= $bhk?> Residential apartments </b></h4></br>
        ...
        return false;
                ...
                <center><h2 class="sppb-title-heading delay-10s animated wow fadeInDown animated"
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 no-padding banner-patch-content">
                        <center><h4><b>Area</b></h4></center>
                        <a data-link="#" class="myclick_link" ><center><img src="<?= base_url('assets/banner_patch/banner-patch-1.png') ?>" class="img-responsive"></center></a>
                        <center><p><span> - </span></p></center>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 no-padding banner-patch-content">
                 ...
                 <center> <a class="btn btn-danger" id="down-brochure">Click here to Get
                                                        Brochure</a>
