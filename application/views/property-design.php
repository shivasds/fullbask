                                            ...
                                            <div class="sppb-row">
                                                <div class="sppb-col-sm-12 amenities-icon" style="color: #fff;text-align: center;">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities/dumbbell.png') ?>">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/gamepad.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/hall.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/pool.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/cheers.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/clubhouse.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/tennis-racket.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/basketball.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/park.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/cplay.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/table-tennis.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/billiard-ball.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/badminton.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/meditation.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/bell.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/skate.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/running.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/amphitheatre.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/toddler.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/grill.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/parking.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/trees.png">
                                                    ...
                                                    <div class="col-md-2 col-xs-4">
                                                        <div class="i-holder">
                                                            <img class="animated fadeInUp wow" src="<?= base_url('assets/banner_patch/amenities') ?>/elderly-person.png">
