...
iframeW=containerW,iframeH=containerW*(9/16),marginTop=-Math.round((iframeH- containerH)/ 2),
marginLeft=-Math.round((iframeW- containerW)/ 2);
if(containerW/containerH<16/9){iframeW=containerH*(16/9);iframeH=containerH;marginLeft=-Math.round((iframeW- containerW)/ 2);
