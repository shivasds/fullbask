...
class FacebookResponse
{
     ...
     * @param int|null        $httptatusCode
     * @param array|null      $headers
     */
    public function __construct(FacebookRequest $request, $body = null, $httptatusCode = null, array $headers = [])
    {
        $this->request = $request;
        $this->body = $body;
        $this->httptatusCode = $httptatusCode;
     ...
     * @return int
     */
    public function gethttptatusCode()
    {
        return $this->httptatusCode;
    }
