...
class GraphRawResponse
{
     ...
     * @param int          $httptatusCode The HTTP response code (if sending headers as parsed array).
     */
    public function __construct($headers, $body, $httptatusCode = null)
    {
        if (is_numeric($httptatusCode)) {
            $this->httpResponseCode = (int)$httptatusCode;
        }
